...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_35__body_container_routines_routines_component__ = __webpack_require__("../../../../../src/app/body-container/routines/routines.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_36__body_container_routines_routine_list_routine_list_component__ = __webpack_require__("../../../../../src/app/body-container/routines/routine-list/routine-list.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_37__body_container_routines_routine_edit_routine_edit_component__ = __webpack_require__("../../../../../src/app/body-container/routines/routine-edit/routine-edit.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_38__body_container_routines_routine_edit_task_list_task_list_component__ = __webpack_require__("../../../../../src/app/body-container/routines/routine-edit/task-list/task-list.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_39__body_container_routines_routine_edit_task_list_task_edit_item_task_edit_item_component__ = __webpack_require__("../../../../../src/app/body-container/routines/routine-edit/task-list/task-edit-item/task-edit-item.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_40__body_container_routines_routine_edit_routine_edit_form_routine_edit_form_component__ = __webpack_require__("../../../../../src/app/body-container/routines/routine-edit/routine-edit-form/routine-edit-form.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_41__body_container_routines_routine_list_routine_list_item_routine_list_item_component__ = __webpack_require__("../../../../../src/app/body-container/routines/routine-list/routine-list-item/routine-list-item.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_42__services_routines_service__ = __webpack_require__("../../../../../src/app/services/routines.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_43__body_container_routines_routine_edit_task_list_task_item_task_item_component__ = __webpack_require__("../../../../../src/app/body-container/routines/routine-edit/task-list/task-item/task-item.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var appRoutes = [
    ...
    { path: 'routines', component: __WEBPACK_IMPORTED_MODULE_35__body_container_routines_routines_component__["a" /* RoutinesComponent */] },
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["M" /* NgModule */])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_35__body_container_routines_routines_component__["a" /* RoutinesComponent */],
            __WEBPACK_IMPORTED_MODULE_36__body_container_routines_routine_list_routine_list_component__["a" /* RoutineListComponent */],
            __WEBPACK_IMPORTED_MODULE_37__body_container_routines_routine_edit_routine_edit_component__["a" /* RoutineEditComponent */],
            __WEBPACK_IMPORTED_MODULE_38__body_container_routines_routine_edit_task_list_task_list_component__["a" /* TaskListComponent */],
            __WEBPACK_IMPORTED_MODULE_39__body_container_routines_routine_edit_task_list_task_edit_item_task_edit_item_component__["a" /* TaskEditItemComponent */],
            __WEBPACK_IMPORTED_MODULE_40__body_container_routines_routine_edit_routine_edit_form_routine_edit_form_component__["a" /* RoutineEditFormComponent */],
            __WEBPACK_IMPORTED_MODULE_41__body_container_routines_routine_list_routine_list_item_routine_list_item_component__["a" /* RoutineListItemComponent */],
            __WEBPACK_IMPORTED_MODULE_43__body_container_routines_routine_edit_task_list_task_item_task_item_component__["a" /* TaskItemComponent */]
        ],
        imports: [
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_22__body_container_ledstrips_controller_service__["a" /* ControllerService */], __WEBPACK_IMPORTED_MODULE_24__body_container_servers_server_service__["a" /* ServerService */], __WEBPACK_IMPORTED_MODULE_34__services_outlets_service__["a" /* OutletsService */], __WEBPACK_IMPORTED_MODULE_42__services_routines_service__["a" /* RoutinesService */]],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__models_color_model__ = __webpack_require__("../../../../../src/app/models/color.model.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var LedstripControllerComponent = (function () {
    ...
    LedstripControllerComponent.prototype.change = function () {
        var color = new __WEBPACK_IMPORTED_MODULE_4__models_color_model__["a" /* Color */](this.red, this.green, this.blue);
    ...
    LedstripControllerComponent.prototype.selectController = function () {
        ...
        this.ledStripService.getLedstrips(this.selectedController._id)
            ...
            if (_this.ledstrips[0].color != null) {
                _this.red = _this.ledstrips[0].color.red;
                _this.green = _this.ledstrips[0].color.green;
                _this.blue = _this.ledstrips[0].color.blue;
            }
        })
            .catch(function (error) { return console.log(error); });
    };
...
/***/ "../../../../../src/app/body-container/routines/routine-edit/routine-edit-form/routine-edit-form.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../../src/app/body-container/routines/routine-edit/routine-edit-form/routine-edit-form.component.html":
/***/ (function(module, exports) {

module.exports = "<form [formGroup]=\"form\" (ngSubmit)=\"save()\">\n  <div class=\"row\">\n    <div class=\"col-xs-12\">\n      <label for=\"name\">Name</label>\n      <input type=\"text\" id=\"name\" formControlName=\"name\" class=\"form-control\">\n      <br/>\n      <button *ngIf=\"editMode\" class=\"btn btn-green\" [disabled]=\"!form.valid\">Update</button>\n      <button *ngIf=\"!editMode\" class=\"btn btn-green\" [disabled]=\"!form.valid\">Create</button>\n    </div>\n  </div>\n</form>\n"

/***/ }),

/***/ "../../../../../src/app/body-container/routines/routine-edit/routine-edit-form/routine-edit-form.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return RoutineEditFormComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__models_routine_model__ = __webpack_require__("../../../../../src/app/models/routine.model.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_routines_service__ = __webpack_require__("../../../../../src/app/services/routines.service.ts");
...
var RoutineEditFormComponent = (function () {
    function RoutineEditFormComponent(service) {
        this.service = service;
        this.routine = new __WEBPACK_IMPORTED_MODULE_1__models_routine_model__["a" /* Routine */]();
        this.editMode = false;
    }
    RoutineEditFormComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.service.routineSelected.subscribe(function (routine) {
    ...
    RoutineEditFormComponent.prototype.save = function () {
        var _this = this;
        if (this.editMode) {
    ...
    RoutineEditFormComponent.prototype.cancel = function () {
        this.editMode = false;
        this.initForm();
    };
    RoutineEditFormComponent.prototype.initForm = function () {
        var routineName = '';
        if (this.editMode) {
            routineName = this.routine.name;
        }
        this.form = new __WEBPACK_IMPORTED_MODULE_3__angular_forms__["b" /* FormGroup */]({
            'name': new __WEBPACK_IMPORTED_MODULE_3__angular_forms__["a" /* FormControl */](routineName, __WEBPACK_IMPORTED_MODULE_3__angular_forms__["e" /* Validators */].required)
        });
    };
    return RoutineEditFormComponent;
}());
RoutineEditFormComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["o" /* Component */])({
        selector: 'app-routine-edit-form',
        template: __webpack_require__("../../../../../src/app/body-container/routines/routine-edit/routine-edit-form/routine-edit-form.component.html"),
        styles: [__webpack_require__("../../../../../src/app/body-container/routines/routine-edit/routine-edit-form/routine-edit-form.component.css")]
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2__services_routines_service__["a" /* RoutinesService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services_routines_service__["a" /* RoutinesService */]) === "function" && _a || Object])
], RoutineEditFormComponent);

var _a;
//# sourceMappingURL=routine-edit-form.component.js.map

/***/ }),

/***/ "../../../../../src/app/body-container/routines/routine-edit/routine-edit.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../../src/app/body-container/routines/routine-edit/routine-edit.component.html":
/***/ (function(module, exports) {

module.exports = "<div class=\"col-xl-6 col-md-6 col-xs-12\">\n  <div class=\"card\">\n    <div class=\"card-header\"><h4 class=\"card-title\">Edit routines</h4></div>\n    <div class=\"card-body collapse in\">\n      <div class=\"card-block\">\n        <app-routine-edit-form></app-routine-edit-form>\n        <app-task-list></app-task-list>\n      </div>\n    </div>\n  </div>\n</div>\n\n"

/***/ }),

/***/ "../../../../../src/app/body-container/routines/routine-edit/routine-edit.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return RoutineEditComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_routines_service__ = __webpack_require__("../../../../../src/app/services/routines.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var RoutineEditComponent = (function () {
    function RoutineEditComponent(service) {
        this.service = service;
    }
    RoutineEditComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.service.routineSelected.subscribe(function (routine) { return _this.routine = routine; });
    };
    return RoutineEditComponent;
}());
RoutineEditComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["o" /* Component */])({
        selector: 'app-routine-edit',
        template: __webpack_require__("../../../../../src/app/body-container/routines/routine-edit/routine-edit.component.html"),
        styles: [__webpack_require__("../../../../../src/app/body-container/routines/routine-edit/routine-edit.component.css")]
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__services_routines_service__["a" /* RoutinesService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__services_routines_service__["a" /* RoutinesService */]) === "function" && _a || Object])
], RoutineEditComponent);

var _a;
//# sourceMappingURL=routine-edit.component.js.map

/***/ }),

/***/ "../../../../../src/app/body-container/routines/routine-edit/task-list/task-edit-item/task-edit-item.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../../src/app/body-container/routines/routine-edit/task-list/task-edit-item/task-edit-item.component.html":
/***/ (function(module, exports) {

module.exports = "<form [formGroup]=\"form\" (ngSubmit)=\"save()\">\n  <div class=\"row\">\n    <div class=\"col-xs-3\">\n      <input type=\"text\" placeholder=\"Type\" id=\"type\" formControlName=\"type\" class=\"form-control\">\n    </div>\n    <div class=\"col-xs-3\">\n      <input type=\"text\" placeholder=\"Value\" id=\"value\" formControlName=\"value\" class=\"form-control\">\n    </div>\n    <div class=\"col-xs-3\">\n      <input type=\"text\" placeholder=\"Time\" id=\"sleepTime\" formControlName=\"sleepTime\" class=\"form-control\">\n    </div>\n    <div class=\"col-xs-3\">\n      <button class=\"btn btn-green\" [disabled]=\"!form.valid\">Save</button>\n    </div>\n  </div>\n</form>\n\n"

/***/ }),

/***/ "../../../../../src/app/body-container/routines/routine-edit/task-list/task-edit-item/task-edit-item.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return TaskEditItemComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
...
var TaskEditItemComponent = (function () {
    function TaskEditItemComponent(service) {
        this.service = service;
    }
    TaskEditItemComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.service.routineSelected.subscribe(function (routine) { return _this.id = routine._id; });
        this.initForm();
    };
    TaskEditItemComponent.prototype.save = function () {
        var _this = this;
    ...
    TaskEditItemComponent.prototype.initForm = function () {
        var value = '';
        var type = '';
        var sleepTime = 0;
        this.form = new __WEBPACK_IMPORTED_MODULE_3__angular_forms__["b" /* FormGroup */]({
            'type': new __WEBPACK_IMPORTED_MODULE_3__angular_forms__["a" /* FormControl */](type, __WEBPACK_IMPORTED_MODULE_3__angular_forms__["e" /* Validators */].required),
            'value': new __WEBPACK_IMPORTED_MODULE_3__angular_forms__["a" /* FormControl */](value, __WEBPACK_IMPORTED_MODULE_3__angular_forms__["e" /* Validators */].required),
            'sleepTime': new __WEBPACK_IMPORTED_MODULE_3__angular_forms__["a" /* FormControl */](sleepTime, __WEBPACK_IMPORTED_MODULE_3__angular_forms__["e" /* Validators */].required)
        });
    };
    return TaskEditItemComponent;
}());
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["F" /* Input */])(),
    __metadata("design:type", String)
], TaskEditItemComponent.prototype, "id", void 0);
TaskEditItemComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["o" /* Component */])({
        selector: 'app-task-edit-item',
        template: __webpack_require__("../../../../../src/app/body-container/routines/routine-edit/task-list/task-edit-item/task-edit-item.component.html"),
        styles: [__webpack_require__("../../../../../src/app/body-container/routines/routine-edit/task-list/task-edit-item/task-edit-item.component.css")]
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2__services_routines_service__["a" /* RoutinesService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services_routines_service__["a" /* RoutinesService */]) === "function" && _a || Object])
], TaskEditItemComponent);

var _a;
//# sourceMappingURL=task-edit-item.component.js.map

/***/ }),

/***/ "../../../../../src/app/body-container/routines/routine-edit/task-list/task-item/task-item.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../../src/app/body-container/routines/routine-edit/task-list/task-item/task-item.component.html":
/***/ (function(module, exports) {

module.exports = "<td>{{task.type}}</td>\n<td>{{task.value}}</td>\n<td>{{task.sleepTime}}</td>\n<td><button class=\"btn btn-red\" (click)=\"delete()\">delete</button></td>\n"

/***/ }),

/***/ "../../../../../src/app/body-container/routines/routine-edit/task-list/task-item/task-item.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var TaskItemComponent = (function () {
    function TaskItemComponent(service) {
        this.service = service;
    }
    TaskItemComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.service.routineSelected.subscribe(function (routine) {
            _this.id = routine._id;
        });
    };
...
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["F" /* Input */])(),
    __metadata("design:type", String)
], TaskItemComponent.prototype, "id", void 0);
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["F" /* Input */])(),
...
TaskItemComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["o" /* Component */])({
        ...
        template: __webpack_require__("../../../../../src/app/body-container/routines/routine-edit/task-list/task-item/task-item.component.html"),
        styles: [__webpack_require__("../../../../../src/app/body-container/routines/routine-edit/task-list/task-item/task-item.component.css")]
    }),
    __metadata("design:paramtypes", [typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__services_routines_service__["a" /* RoutinesService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services_routines_service__["a" /* RoutinesService */]) === "function" && _b || Object])
], TaskItemComponent);
...
/***/ "../../../../../src/app/body-container/routines/routine-edit/task-list/task-list.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../../src/app/body-container/routines/routine-edit/task-list/task-list.component.html":
/***/ (function(module, exports) {

module.exports = "<div class=\"table-responsive\">\n  <table class=\"table\">\n    <thead>\n      <td>Type</td>\n      <td>value</td>\n      <td>sleepTime</td>\n      <td></td>\n    </thead>\n    <tbody>\n      <tr\n        *ngFor=\"let t of routine.tasks\"\n        app-task-item\n        [task]=\"t\"\n        [id]=\"id\"\n      ></tr>\n    </tbody>\n  </table>\n</div>\n<app-task-edit-item [id]=\"id\"></app-task-edit-item>\n"

/***/ }),

/***/ "../../../../../src/app/body-container/routines/routine-edit/task-list/task-list.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_routines_service__ = __webpack_require__("../../../../../src/app/services/routines.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__models_routine_model__ = __webpack_require__("../../../../../src/app/models/routine.model.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var TaskListComponent = (function () {
    function TaskListComponent(service) {
        this.service = service;
        this.routine = new __WEBPACK_IMPORTED_MODULE_2__models_routine_model__["a" /* Routine */]();
    }
    TaskListComponent.prototype.ngOnInit = function () {
        ...
        this.service.routinesChanged.subscribe(function (routines) {
...
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["F" /* Input */])(),
    __metadata("design:type", String)
], TaskListComponent.prototype, "id", void 0);
TaskListComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["o" /* Component */])({
        selector: 'app-task-list',
        template: __webpack_require__("../../../../../src/app/body-container/routines/routine-edit/task-list/task-list.component.html"),
        styles: [__webpack_require__("../../../../../src/app/body-container/routines/routine-edit/task-list/task-list.component.css")]
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__services_routines_service__["a" /* RoutinesService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__services_routines_service__["a" /* RoutinesService */]) === "function" && _a || Object])
], TaskListComponent);
...
/***/ "../../../../../src/app/body-container/routines/routine-list/routine-list-item/routine-list-item.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../../src/app/body-container/routines/routine-list/routine-list-item/routine-list-item.component.html":
/***/ (function(module, exports) {

module.exports = "<td>{{routine.name}}</td>\n<td>\n  <button class=\"btn btn-info\" (click)=\"select()\">Edit</button>\n  <button class=\"btn btn-danger\" (click)=\"delete()\">Delete</button>\n  <button class=\"btn btn-green\" (click)=\"execute()\">Execute</button>\n</td>\n"

/***/ }),

/***/ "../../../../../src/app/body-container/routines/routine-list/routine-list-item/routine-list-item.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return RoutineListItemComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__models_routine_model__ = __webpack_require__("../../../../../src/app/models/routine.model.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_routines_service__ = __webpack_require__("../../../../../src/app/services/routines.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
...
var RoutineListItemComponent = (function () {
    function RoutineListItemComponent(service) {
        this.service = service;
    }
    RoutineListItemComponent.prototype.ngOnInit = function () {
    };
    RoutineListItemComponent.prototype.select = function () {
        this.service.selectRoutine(this.routine);
    };
    RoutineListItemComponent.prototype.delete = function () {
        this.service.deleteRoutine(this.routine._id)
            .then()
            .catch(function (err) { return console.log(err); });
    };
    RoutineListItemComponent.prototype.execute = function () {
        this.service.executeRoutine(this.routine._id)
            .then()
            .catch(function (err) { return console.log(err); });
    };
    return RoutineListItemComponent;
}());
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["F" /* Input */])(),
    __metadata("design:type", typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__models_routine_model__["a" /* Routine */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__models_routine_model__["a" /* Routine */]) === "function" && _a || Object)
], RoutineListItemComponent.prototype, "routine", void 0);
RoutineListItemComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["o" /* Component */])({
        selector: '[app-routine-list-item]',
        template: __webpack_require__("../../../../../src/app/body-container/routines/routine-list/routine-list-item/routine-list-item.component.html"),
        styles: [__webpack_require__("../../../../../src/app/body-container/routines/routine-list/routine-list-item/routine-list-item.component.css")]
    }),
    __metadata("design:paramtypes", [typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__services_routines_service__["a" /* RoutinesService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services_routines_service__["a" /* RoutinesService */]) === "function" && _b || Object])
], RoutineListItemComponent);

var _a, _b;
//# sourceMappingURL=routine-list-item.component.js.map

/***/ }),

/***/ "../../../../../src/app/body-container/routines/routine-list/routine-list.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../../src/app/body-container/routines/routine-list/routine-list.component.html":
/***/ (function(module, exports) {

module.exports = "<div class=\"col-xl-6 col-md-6 col-xs-12\">\n  <div class=\"card\">\n    <div class=\"card-header\"><h4 class=\"card-title\">Routines</h4></div>\n    <div class=\"card-body collapse in\">\n      <div class=\"card-block\">\n        <div class=\"table-responsive\">\n          <table class=\"table\">\n            <thead>\n            <tr>\n              <td>name</td>\n              <td>actions</td>\n              <td></td>\n            </tr>\n            </thead>\n            <tbody>\n              <tr\n                *ngFor=\"let r of routines\"\n                app-routine-list-item\n                [routine]=\"r\"\n              >\n              </tr>\n            </tbody>\n          </table>\n        </div>\n      </div>\n    </div>\n  </div>\n</div>\n\n"

/***/ }),

/***/ "../../../../../src/app/body-container/routines/routine-list/routine-list.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return RoutineListComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_routines_service__ = __webpack_require__("../../../../../src/app/services/routines.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
...
var RoutineListComponent = (function () {
    function RoutineListComponent(service) {
        this.service = service;
    }
    RoutineListComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.service.getRoutines()
            .then(function (routines) { return _this.routines = routines; })
            .catch(function (err) { return console.log(err); });
        this.service.routinesChanged.subscribe(function (routines) { return _this.routines = routines; });
    };
...
RoutineListComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["o" /* Component */])({
        ...
        template: __webpack_require__("../../../../../src/app/body-container/routines/routine-list/routine-list.component.html"),
        styles: [__webpack_require__("../../../../../src/app/body-container/routines/routine-list/routine-list.component.css")]
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__services_routines_service__["a" /* RoutinesService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__services_routines_service__["a" /* RoutinesService */]) === "function" && _a || Object])
], RoutineListComponent);

var _a;
//# sourceMappingURL=routine-list.component.js.map

/***/ }),

/***/ "../../../../../src/app/body-container/routines/routines.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../../src/app/body-container/routines/routines.component.html":
/***/ (function(module, exports) {

module.exports = "<app-routine-list></app-routine-list>\n<app-routine-edit></app-routine-edit>\n"

/***/ }),

/***/ "../../../../../src/app/body-container/routines/routines.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return RoutinesComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var RoutinesComponent = (function () {
...
RoutinesComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["o" /* Component */])({
        ...
        template: __webpack_require__("../../../../../src/app/body-container/routines/routines.component.html"),
        styles: [__webpack_require__("../../../../../src/app/body-container/routines/routines.component.css")]
    }),
    __metadata("design:paramtypes", [])
], RoutinesComponent);

//# sourceMappingURL=routines.component.js.map
...
/***/ "../../../../../src/app/services/routines.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return RoutinesService; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_http__ = __webpack_require__("../../../http/@angular/http.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__environments_env__ = __webpack_require__("../../../../../src/app/environments/env.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_Subject__ = __webpack_require__("../../../../rxjs/_esm5/Subject.js");
...
var RoutinesService = (function () {
    function RoutinesService(http) {
        this.http = http;
        this.routinesChanged = new __WEBPACK_IMPORTED_MODULE_3_rxjs_Subject__["a" /* Subject */]();
        this.routineSelected = new __WEBPACK_IMPORTED_MODULE_3_rxjs_Subject__["a" /* Subject */]();
        this.headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]({ 'content-type': 'application/json' });
        this.rUrl = __WEBPACK_IMPORTED_MODULE_2__environments_env__["a" /* env */].serverUrl + '/routines/';
        this.tUrl = __WEBPACK_IMPORTED_MODULE_2__environments_env__["a" /* env */].serverUrl + '/tasks/';
    }
    RoutinesService.prototype.selectRoutine = function (routine) {
        this.routineSelected.next(routine);
    };
    RoutinesService.prototype.getRoutines = function () {
        var _this = this;
        return this.http.get(this.rUrl, { headers: this.headers })
            .toPromise()
            .then(function (routines) {
            _this.routines = routines.json();
            _this.routinesChanged.next(_this.routines.slice());
            return _this.routines;
        })
            .catch(function (err) {
            return _this.handleError(err);
        });
    ...
    RoutinesService.prototype.getRoutine = function (id) {
        var _this = this;
        return this.http.get(this.rUrl + id, { headers: this.headers })
            .toPromise()
    ...
    RoutinesService.prototype.addRoutine = function (routine) {
        var _this = this;
        return this.http.post(this.rUrl, routine, { headers: this.headers })
            .toPromise()
            .then(function () {
            _this.getRoutines()
                .then(function () {
    ...
    RoutinesService.prototype.addTask = function (task, id) {
        var _this = this;
        console.log(task, id);
        return this.http.post(this.tUrl + id, task, { headers: this.headers })
            .toPromise()
            .then(function () {
            _this.getRoutines()
                .then(function () {
    ...
    RoutinesService.prototype.updateRoutine = function (routine) {
        var _this = this;
        return this.http.put(this.rUrl + routine._id, routine, { headers: this.headers })
            .toPromise()
            .then(function () {
            _this.getRoutines()
                .then(function () {
    ...
    RoutinesService.prototype.updateTask = function (task) {
        var _this = this;
        return this.http.put(this.tUrl + task._id, task, { headers: this.headers })
            .toPromise()
            .then(function () {
            _this.getRoutines()
                .then(function () {
    ...
    RoutinesService.prototype.deleteRoutine = function (id) {
        var _this = this;
        return this.http.delete(this.rUrl + id, { headers: this.headers })
            .toPromise()
            .then(function () {
            _this.getRoutines()
                .then(function () {
    ...
    RoutinesService.prototype.deleteTask = function (task, routine) {
        var _this = this;
        return this.http.delete(this.tUrl + routine + '/' + task, { headers: this.headers })
            .toPromise()
            .then(function () {
            _this.getRoutines()
                .then(function () {
    ...
    RoutinesService.prototype.executeRoutine = function (id) {
        var _this = this;
        return this.http.get(this.rUrl + 'execute/' + id, { headers: this.headers })
            .toPromise()
            .then(function () {
            return true;
        })
    ...
    RoutinesService.prototype.handleError = function (error) {
